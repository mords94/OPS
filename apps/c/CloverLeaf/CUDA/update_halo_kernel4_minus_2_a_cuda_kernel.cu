...
//
__constant__ int dims_update_halo_kernel4_minus_2_a [3][1];
static int dims_update_halo_kernel4_minus_2_a_h [3][1] = {0};
...
int size1 ){
  ...
  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel4_minus_2_a[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel4_minus_2_a[1][0];

  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_update_halo_kernel4_minus_2_a[0][0], arg0);
    ACC<double> argp1(dims_update_halo_kernel4_minus_2_a[1][0], arg1);
    update_halo_kernel4_minus_2_a_gpu(
     argp0, argp1, arg2);
  }
...
void ops_par_loop_update_halo_kernel4_minus_2_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,42,"update_halo_kernel4_minus_2_a");
  ...
  if (xdim0 != dims_update_halo_kernel4_minus_2_a_h[0][0] || xdim1 != dims_update_halo_kernel4_minus_2_a_h[1][0]) {
    dims_update_halo_kernel4_minus_2_a_h[0][0] = xdim0;
    dims_update_halo_kernel4_minus_2_a_h[1][0] = xdim1;
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_update_halo_kernel4_minus_2_a, dims_update_halo_kernel4_minus_2_a_h, sizeof(dims_update_halo_kernel4_minus_2_a)));
  }
