...
void ops_par_loop_update_halo_kernel2_yvel_plus_2_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_update_halo_kernel2_yvel_plus_2_a_h[0][0] || xdim1 != dims_update_halo_kernel2_yvel_plus_2_a_h[1][0]) {
    ...
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_update_halo_kernel2_yvel_plus_2_a, dims_update_halo_kernel2_yvel_plus_2_a_h, sizeof(dims_update_halo_kernel2_yvel_plus_2_a)));
  }
