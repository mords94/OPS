...
int size1 ){
  ...
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_generate_chunk_kernel[5][0];
  arg6 += idx_x * 1*1 + idx_y * 0*1 * dims_generate_chunk_kernel[6][0];
...
void ops_par_loop_generate_chunk_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_generate_chunk_kernel_h[0][0] || xdim1 != dims_generate_chunk_kernel_h[1][0] || xdim2 != dims_generate_chunk_kernel_h[2][0] || xdim3 != dims_generate_chunk_kernel_h[3][0] || xdim4 != dims_generate_chunk_kernel_h[4][0] || xdim5 != dims_generate_chunk_kernel_h[5][0] || xdim6 != dims_generate_chunk_kernel_h[6][0] || xdim7 != dims_generate_chunk_kernel_h[7][0]) {
    ...
    dims_generate_chunk_kernel_h[7][0] = xdim7;
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_generate_chunk_kernel, dims_generate_chunk_kernel_h, sizeof(dims_generate_chunk_kernel)));
  }
