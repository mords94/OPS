...
void ops_par_loop_initialise_chunk_kernel_yy_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_initialise_chunk_kernel_yy_h[0][0]) {
    ...
    cutilSafeCall(block->instance->ostream(), cudaMemcpyToSymbol( dims_initialise_chunk_kernel_yy, dims_initialise_chunk_kernel_yy_h, sizeof(dims_initialise_chunk_kernel_yy)));
  }
