...
void ops_par_loop_advec_mom_kernel2_x_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> vel1(xdim0_advec_mom_kernel2_x, vel1_p + n_x*1 + n_y * xdim0_advec_mom_kernel2_x*1);
      const ACC<double> node_mass_post(xdim1_advec_mom_kernel2_x, node_mass_post_p + n_x*1 + n_y * xdim1_advec_mom_kernel2_x*1);
      const ACC<double> node_mass_pre(xdim2_advec_mom_kernel2_x, node_mass_pre_p + n_x*1 + n_y * xdim2_advec_mom_kernel2_x*1);
      const ACC<double> mom_flux(xdim3_advec_mom_kernel2_x, mom_flux_p + n_x*1 + n_y * xdim3_advec_mom_kernel2_x*1);
