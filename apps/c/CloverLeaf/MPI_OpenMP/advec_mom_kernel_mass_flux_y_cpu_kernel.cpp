...
void ops_par_loop_advec_mom_kernel_mass_flux_y_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> node_flux(xdim0_advec_mom_kernel_mass_flux_y, node_flux_p + n_x*1 + n_y * xdim0_advec_mom_kernel_mass_flux_y*1);
      const ACC<double> mass_flux_y(xdim1_advec_mom_kernel_mass_flux_y, mass_flux_y_p + n_x*1 + n_y * xdim1_advec_mom_kernel_mass_flux_y*1);
