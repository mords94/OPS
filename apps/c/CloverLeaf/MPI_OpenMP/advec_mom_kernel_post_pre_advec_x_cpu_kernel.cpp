...
void ops_par_loop_advec_mom_kernel_post_pre_advec_x_execute(ops_kernel_descriptor *desc) {
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ACC<double> node_mass_post(xdim0_advec_mom_kernel_post_pre_advec_x, node_mass_post_p + n_x*1 + n_y * xdim0_advec_mom_kernel_post_pre_advec_x*1);
      const ACC<double> post_vol(xdim1_advec_mom_kernel_post_pre_advec_x, post_vol_p + n_x*1 + n_y * xdim1_advec_mom_kernel_post_pre_advec_x*1);
      const ACC<double> density1(xdim2_advec_mom_kernel_post_pre_advec_x, density1_p + n_x*1 + n_y * xdim2_advec_mom_kernel_post_pre_advec_x*1);
      ACC<double> node_mass_pre(xdim3_advec_mom_kernel_post_pre_advec_x, node_mass_pre_p + n_x*1 + n_y * xdim3_advec_mom_kernel_post_pre_advec_x*1);
      const ACC<double> node_flux(xdim4_advec_mom_kernel_post_pre_advec_x, node_flux_p + n_x*1 + n_y * xdim4_advec_mom_kernel_post_pre_advec_x*1);
