...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_yvel_minus_2_b(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_update_halo_kernel2_yvel_minus_2_b) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel2_yvel_minus_2_b "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling update_halo_kernel2_yvel_minus_2_b -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[28] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_minus_2_b", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_yvel_minus_2_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_update_halo_kernel2_yvel_minus_2_b(block->instance,
  xdim0,xdim1);
