...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_yvel_minus_4_b(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_update_halo_kernel2_yvel_minus_4_b) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel2_yvel_minus_4_b "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_minus_4_b=%d  -Dxdim1_update_halo_kernel2_yvel_minus_4_b=%d ", pPath, 32,xdim0,xdim1);
            else
          ...
          instance->ostream() << "compiling update_halo_kernel2_yvel_minus_4_b -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[27] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_minus_4_b", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_yvel_minus_4_b(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_update_halo_kernel2_yvel_minus_4_b(block->instance,
  xdim0,xdim1);
