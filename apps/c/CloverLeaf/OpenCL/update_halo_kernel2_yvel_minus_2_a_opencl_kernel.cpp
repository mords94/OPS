...
//
    ...
    void buildOpenCLKernels_update_halo_kernel2_yvel_minus_2_a(OPS_instance *instance, int xdim0, int xdim1) {
      ...
      if(!isbuilt_update_halo_kernel2_yvel_minus_2_a) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel2_yvel_minus_2_a "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_update_halo_kernel2_yvel_minus_2_a=%d  -Dxdim1_update_halo_kernel2_yvel_minus_2_a=%d ", pPath, 32,xdim0,xdim1);
            else
          ...
          instance->ostream() << "compiling update_halo_kernel2_yvel_minus_2_a -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[26] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel2_yvel_minus_2_a", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel2_yvel_minus_2_a(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_update_halo_kernel2_yvel_minus_2_a(block->instance,
  xdim0,xdim1);
