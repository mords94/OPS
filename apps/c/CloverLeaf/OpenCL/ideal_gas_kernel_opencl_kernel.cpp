...
//
    ...
    void buildOpenCLKernels_ideal_gas_kernel(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_ideal_gas_kernel) {
        ...
        instance->ostream() <<"Compiling ideal_gas_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_ideal_gas_kernel=%d  -Dxdim1_ideal_gas_kernel=%d  -Dxdim2_ideal_gas_kernel=%d  -Dxdim3_ideal_gas_kernel=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
            else
          ...
          instance->ostream() << "compiling ideal_gas_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[8] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_ideal_gas_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_ideal_gas_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  buildOpenCLKernels_ideal_gas_kernel(block->instance,
