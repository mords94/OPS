...
//
    ...
    void buildOpenCLKernels_advec_mom_kernel2_x(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_advec_mom_kernel2_x) {
        ...
        instance->ostream() <<"Compiling advec_mom_kernel2_x "<<OCL_FMA<<" source -- start \n";
          ...
          if (pPath!=NULL)
            if(OCL_FMA)
              sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/include -DOPS_WARPSIZE=%d  -Dxdim0_advec_mom_kernel2_x=%d  -Dxdim1_advec_mom_kernel2_x=%d  -Dxdim2_advec_mom_kernel2_x=%d  -Dxdim3_advec_mom_kernel2_x=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3);
            else
          ...
          instance->ostream() << "compiling advec_mom_kernel2_x -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[75] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_advec_mom_kernel2_x", &ret);
        clSafeCall( ret );
...
void ops_par_loop_advec_mom_kernel2_x(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  buildOpenCLKernels_advec_mom_kernel2_x(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[75], 6, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[75], 7, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[75], 8, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[75], 9, sizeof(cl_int), (void*) &y_size ));
