...
//
    ...
    void buildOpenCLKernels_update_halo_kernel1_b2(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6) {
      ...
      if(!isbuilt_update_halo_kernel1_b2) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel1_b2 "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling update_halo_kernel1_b2 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[9] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel1_b2", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel1_b2(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,9,"update_halo_kernel1_b2");
  ...
  buildOpenCLKernels_update_halo_kernel1_b2(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[9], 8, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[9], 9, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[9], 10, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[9], 11, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[9], 12, sizeof(cl_int), (void*) &base4 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[9], 13, sizeof(cl_int), (void*) &base5 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[9], 14, sizeof(cl_int), (void*) &base6 ));
