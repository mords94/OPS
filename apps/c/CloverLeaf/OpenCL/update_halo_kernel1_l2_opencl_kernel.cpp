...
//
    ...
    void buildOpenCLKernels_update_halo_kernel1_l2(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3, int xdim4, int xdim5, int xdim6) {
      ...
      if(!isbuilt_update_halo_kernel1_l2) {
        ...
        instance->ostream() <<"Compiling update_halo_kernel1_l2 "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling update_halo_kernel1_l2 -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[13] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_update_halo_kernel1_l2", &ret);
        clSafeCall( ret );
...
void ops_par_loop_update_halo_kernel1_l2(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6, ops_arg arg7) {
  ...
  buildOpenCLKernels_update_halo_kernel1_l2(block->instance,
