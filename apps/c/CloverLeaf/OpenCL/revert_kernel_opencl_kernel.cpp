...
//
    ...
    void buildOpenCLKernels_revert_kernel(OPS_instance *instance, int xdim0, int xdim1, int xdim2, int xdim3) {
      ...
      if(!isbuilt_revert_kernel) {
        ...
        instance->ostream() <<"Compiling revert_kernel "<<OCL_FMA<<" source -- start \n";
          ...
          instance->ostream() << "compiling revert_kernel -- done\n";

        // Create the OpenCL kernel
        instance->opencl_instance->OPS_opencl_core.kernel[57] = clCreateKernel(instance->opencl_instance->OPS_opencl_core.program, "ops_revert_kernel", &ret);
        clSafeCall( ret );
...
void ops_par_loop_revert_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,57,"revert_kernel");
  ...
  buildOpenCLKernels_revert_kernel(block->instance,
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[57], 2, sizeof(cl_mem), (void*) &arg2.data_d ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[57], 3, sizeof(cl_mem), (void*) &arg3.data_d ));
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[57], 6, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[57], 7, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[57], 8, sizeof(cl_int), (void*) &x_size ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[57], 9, sizeof(cl_int), (void*) &y_size ));
  ...
  if (block->instance->OPS_diags > 1) {
    ...
    block->instance->OPS_kernels[57].transfer += ops_compute_transfer(dim, start, end, &arg2);
    block->instance->OPS_kernels[57].transfer += ops_compute_transfer(dim, start, end, &arg3);
  }
}
