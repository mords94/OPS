...
void advec_mom_kernel_x1_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double pre_vol = { pre_vol_p + n_x*1 + n_y * xdim0_advec_mom_kernel_x1*1, xdim0_advec_mom_kernel_x1};
      ptr_double post_vol = { post_vol_p + n_x*1 + n_y * xdim1_advec_mom_kernel_x1*1, xdim1_advec_mom_kernel_x1};
