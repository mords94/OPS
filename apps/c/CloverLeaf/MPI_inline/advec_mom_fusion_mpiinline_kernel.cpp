...
extern int xdim0_advec_mom_fusion;
int xdim0_advec_mom_fusion_h = -1;
extern int xdim1_advec_mom_fusion;
int xdim1_advec_mom_fusion_h = -1;
extern int xdim2_advec_mom_fusion;
int xdim2_advec_mom_fusion_h = -1;
extern int xdim3_advec_mom_fusion;
int xdim3_advec_mom_fusion_h = -1;
extern int xdim4_advec_mom_fusion;
int xdim4_advec_mom_fusion_h = -1;
extern int xdim5_advec_mom_fusion;
int xdim5_advec_mom_fusion_h = -1;
...
void ops_par_loop_advec_mom_fusion(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5) {
  ...
  if (xdim0 != xdim0_advec_mom_fusion_h || xdim1 != xdim1_advec_mom_fusion_h || xdim2 != xdim2_advec_mom_fusion_h || xdim3 != xdim3_advec_mom_fusion_h || xdim4 != xdim4_advec_mom_fusion_h || xdim5 != xdim5_advec_mom_fusion_h) {
    xdim0_advec_mom_fusion = xdim0;
    xdim0_advec_mom_fusion_h = xdim0;
    xdim1_advec_mom_fusion = xdim1;
    xdim1_advec_mom_fusion_h = xdim1;
    xdim2_advec_mom_fusion = xdim2;
    xdim2_advec_mom_fusion_h = xdim2;
    xdim3_advec_mom_fusion = xdim3;
    xdim3_advec_mom_fusion_h = xdim3;
    xdim4_advec_mom_fusion = xdim4;
    xdim4_advec_mom_fusion_h = xdim4;
    xdim5_advec_mom_fusion = xdim5;
    xdim5_advec_mom_fusion_h = xdim5;
  }
