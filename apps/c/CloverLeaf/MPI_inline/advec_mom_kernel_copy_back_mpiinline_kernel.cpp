...
extern int xdim0_advec_mom_kernel_copy_back;
int xdim0_advec_mom_kernel_copy_back_h = -1;
extern int xdim1_advec_mom_kernel_copy_back;
int xdim1_advec_mom_kernel_copy_back_h = -1;
...
void ops_par_loop_advec_mom_kernel_copy_back(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  if (xdim0 != xdim0_advec_mom_kernel_copy_back_h || xdim1 != xdim1_advec_mom_kernel_copy_back_h) {
    xdim0_advec_mom_kernel_copy_back = xdim0;
    xdim0_advec_mom_kernel_copy_back_h = xdim0;
    xdim1_advec_mom_kernel_copy_back = xdim1;
    xdim1_advec_mom_kernel_copy_back_h = xdim1;
  }
  ...
  advec_mom_kernel_copy_back_c_wrapper(
    p_a0,
    p_a1,
    x_size, y_size);
