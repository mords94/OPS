...
void update_halo_kernel4_plus_4_a_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ptr_double ptr0 = {  p_a0 + n_x*1*1 + n_y*xdim0_update_halo_kernel4_plus_4_a*1*1, xdim0_update_halo_kernel4_plus_4_a};
      ptr_double ptr1 = {  p_a1 + n_x*1*1 + n_y*xdim1_update_halo_kernel4_plus_4_a*1*1, xdim1_update_halo_kernel4_plus_4_a};
      update_halo_kernel4_plus_4_a( ptr0, ptr1, p_a2);
    }
  }
}
