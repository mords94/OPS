...
void ops_par_loop_advec_mom_kernel_mass_flux_x_and_post_pre_advec_x(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg,
...
void ops_par_loop_advec_mom_fusion(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg,
  ops_arg,
  ops_arg,
...
void ops_par_loop_advec_mom_kernel_copy_back(char const *, ops_block, int , int*,
  ops_arg,
  ops_arg );
...
#define FUSED_ALL
    ...
    ops_par_loop_advec_mom_kernel_mass_flux_x_and_post_pre_advec_x("advec_mom_kernel_mass_flux_x_and_post_pre_advec_x", clover_grid, 2, range_partx_party_1,
    ...
    ops_par_loop_advec_mom_fusion("advec_mom_fusion", clover_grid, 2, fusion_range,
    ...
    ops_par_loop_advec_mom_kernel_copy_back("advec_mom_kernel_copy_back", clover_grid, 2, fusion_range,
                 ops_arg_dat(work_array1, 1, S2D_00, "double", OPS_READ),
