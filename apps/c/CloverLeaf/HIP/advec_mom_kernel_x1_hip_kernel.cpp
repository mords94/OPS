...
inline void advec_mom_kernel_x1_gpu(ACC<double> &pre_vol,
  ACC<double> &post_vol,
...
int size1 ){
  ...
  if (size0==-1) dims_advec_mom_kernel_x1[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel_x1[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel_x1[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel_x1[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel_x1[3][0];
...
void ops_par_loop_advec_mom_kernel_x1_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_advec_mom_kernel_x1_h[0][0] || xdim1 != dims_advec_mom_kernel_x1_h[1][0] || xdim2 != dims_advec_mom_kernel_x1_h[2][0] || xdim3 != dims_advec_mom_kernel_x1_h[3][0] || xdim4 != dims_advec_mom_kernel_x1_h[4][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_advec_mom_kernel_x1), dims_advec_mom_kernel_x1_h, sizeof(dims_advec_mom_kernel_x1)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_advec_mom_kernel_x1, grid, tblock, 0, 0,
