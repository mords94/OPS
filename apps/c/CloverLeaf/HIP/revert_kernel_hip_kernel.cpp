...
int size1 ){
  ...
  if (size0==-1) dims_revert_kernel[0][0]=0;
...
void ops_par_loop_revert_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_revert_kernel_h[0][0] || xdim1 != dims_revert_kernel_h[1][0] || xdim2 != dims_revert_kernel_h[2][0] || xdim3 != dims_revert_kernel_h[3][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_revert_kernel), dims_revert_kernel_h, sizeof(dims_revert_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_revert_kernel, grid, tblock, 0, 0,
