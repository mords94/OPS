...
//
__constant__ int dims_update_halo_kernel1_r1 [8][1];
static int dims_update_halo_kernel1_r1_h [8][1] = {{0}};
...
int size1 ){
  ...
  if (size0==-1) dims_update_halo_kernel1_r1[0][0]=0;
  ...
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r1[6][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp6(dims_update_halo_kernel1_r1[6][0], arg6);
    update_halo_kernel1_r1_gpu(
...
void ops_par_loop_update_halo_kernel1_r1_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,16,"update_halo_kernel1_r1");
  ...
  if (xdim0 != dims_update_halo_kernel1_r1_h[0][0] || xdim1 != dims_update_halo_kernel1_r1_h[1][0] || xdim2 != dims_update_halo_kernel1_r1_h[2][0] || xdim3 != dims_update_halo_kernel1_r1_h[3][0] || xdim4 != dims_update_halo_kernel1_r1_h[4][0] || xdim5 != dims_update_halo_kernel1_r1_h[5][0] || xdim6 != dims_update_halo_kernel1_r1_h[6][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_update_halo_kernel1_r1), dims_update_halo_kernel1_r1_h, sizeof(dims_update_halo_kernel1_r1)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel1_r1, grid, tblock, 0, 0,
