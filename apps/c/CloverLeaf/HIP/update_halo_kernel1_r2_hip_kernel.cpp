...
//
__constant__ int dims_update_halo_kernel1_r2 [8][1];
static int dims_update_halo_kernel1_r2_h [8][1] = {{0}};
...
int size1 ){
  ...
  if (size0==-1) dims_update_halo_kernel1_r2[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r2[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r2[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r2[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r2[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r2[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r2[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_r2[6][0];
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    ACC<double> argp6(dims_update_halo_kernel1_r2[6][0], arg6);
    update_halo_kernel1_r2_gpu(
...
void ops_par_loop_update_halo_kernel1_r2_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,15,"update_halo_kernel1_r2");
  ...
  if (xdim0 != dims_update_halo_kernel1_r2_h[0][0] || xdim1 != dims_update_halo_kernel1_r2_h[1][0] || xdim2 != dims_update_halo_kernel1_r2_h[2][0] || xdim3 != dims_update_halo_kernel1_r2_h[3][0] || xdim4 != dims_update_halo_kernel1_r2_h[4][0] || xdim5 != dims_update_halo_kernel1_r2_h[5][0] || xdim6 != dims_update_halo_kernel1_r2_h[6][0]) {
    dims_update_halo_kernel1_r2_h[0][0] = xdim0;
    dims_update_halo_kernel1_r2_h[1][0] = xdim1;
    dims_update_halo_kernel1_r2_h[2][0] = xdim2;
    dims_update_halo_kernel1_r2_h[3][0] = xdim3;
    dims_update_halo_kernel1_r2_h[4][0] = xdim4;
    dims_update_halo_kernel1_r2_h[5][0] = xdim5;
    dims_update_halo_kernel1_r2_h[6][0] = xdim6;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_update_halo_kernel1_r2), dims_update_halo_kernel1_r2_h, sizeof(dims_update_halo_kernel1_r2)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel1_r2, grid, tblock, 0, 0,
