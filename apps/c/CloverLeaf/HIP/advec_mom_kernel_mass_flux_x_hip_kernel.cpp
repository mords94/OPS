...
int size1 ){
  ...
  if (size0==-1) dims_advec_mom_kernel_mass_flux_x[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    advec_mom_kernel_mass_flux_x_gpu(
     argp0, argp1);
  }
...
void ops_par_loop_advec_mom_kernel_mass_flux_x_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_advec_mom_kernel_mass_flux_x_h[0][0] || xdim1 != dims_advec_mom_kernel_mass_flux_x_h[1][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_advec_mom_kernel_mass_flux_x), dims_advec_mom_kernel_mass_flux_x_h, sizeof(dims_advec_mom_kernel_mass_flux_x)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_advec_mom_kernel_mass_flux_x, grid, tblock, 0, 0,
