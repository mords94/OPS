...
int size1 ){
  ...
  if (size0==-1) dims_update_halo_kernel2_xvel_minus_4_a[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    update_halo_kernel2_xvel_minus_4_a_gpu(
     argp0, argp1, arg2);
  }
...
void ops_par_loop_update_halo_kernel2_xvel_minus_4_a_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_update_halo_kernel2_xvel_minus_4_a_h[0][0] || xdim1 != dims_update_halo_kernel2_xvel_minus_4_a_h[1][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_update_halo_kernel2_xvel_minus_4_a), dims_update_halo_kernel2_xvel_minus_4_a_h, sizeof(dims_update_halo_kernel2_xvel_minus_4_a)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel2_xvel_minus_4_a, grid, tblock, 0, 0,
