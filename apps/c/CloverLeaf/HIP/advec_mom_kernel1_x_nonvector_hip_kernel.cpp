...
//
__constant__ int dims_advec_mom_kernel1_x_nonvector [5][1];
static int dims_advec_mom_kernel1_x_nonvector_h [5][1] = {{0}};
...
int size1 ){
  ...
  if (size0==-1) dims_advec_mom_kernel1_x_nonvector[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel1_x_nonvector[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel1_x_nonvector[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel1_x_nonvector[2][0];
  arg3 += idx_x * 1*1 + idx_y * 0*1 * dims_advec_mom_kernel1_x_nonvector[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_advec_mom_kernel1_x_nonvector[4][0];

  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_advec_mom_kernel1_x_nonvector[0][0], arg0);
    const ACC<double> argp1(dims_advec_mom_kernel1_x_nonvector[1][0], arg1);
    ACC<double> argp2(dims_advec_mom_kernel1_x_nonvector[2][0], arg2);
    const ACC<double> argp3(dims_advec_mom_kernel1_x_nonvector[3][0], arg3);
    const ACC<double> argp4(dims_advec_mom_kernel1_x_nonvector[4][0], arg4);
    advec_mom_kernel1_x_nonvector_gpu(
...
void ops_par_loop_advec_mom_kernel1_x_nonvector_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,74,"advec_mom_kernel1_x_nonvector");
  ...
  if (xdim0 != dims_advec_mom_kernel1_x_nonvector_h[0][0] || xdim1 != dims_advec_mom_kernel1_x_nonvector_h[1][0] || xdim2 != dims_advec_mom_kernel1_x_nonvector_h[2][0] || xdim3 != dims_advec_mom_kernel1_x_nonvector_h[3][0] || xdim4 != dims_advec_mom_kernel1_x_nonvector_h[4][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_advec_mom_kernel1_x_nonvector), dims_advec_mom_kernel1_x_nonvector_h, sizeof(dims_advec_mom_kernel1_x_nonvector)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_advec_mom_kernel1_x_nonvector, grid, tblock, 0, 0,
