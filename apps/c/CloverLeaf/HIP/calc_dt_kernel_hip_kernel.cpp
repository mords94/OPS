...
int size1 ){
  ...
  if (size0==-1) dims_calc_dt_kernel[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    const ACC<double> argp0(dims_calc_dt_kernel[0][0], arg0);
    const ACC<double> argp1(dims_calc_dt_kernel[1][0], arg1);
    const ACC<double> argp2(dims_calc_dt_kernel[2][0], arg2);
    const ACC<double> argp3(dims_calc_dt_kernel[3][0], arg3);
    const ACC<double> argp4(dims_calc_dt_kernel[4][0], arg4);
    const ACC<double> argp5(dims_calc_dt_kernel[5][0], arg5);
    const ACC<double> argp6(dims_calc_dt_kernel[6][0], arg6);
    const ACC<double> argp7(dims_calc_dt_kernel[7][0], arg7);
    const ACC<double> argp8(dims_calc_dt_kernel[8][0], arg8);
    const ACC<double> argp9(dims_calc_dt_kernel[9][0], arg9);
    ACC<double> argp10(dims_calc_dt_kernel[10][0], arg10);
    calc_dt_kernel_gpu(
...
void ops_par_loop_calc_dt_kernel_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_calc_dt_kernel_h[0][0] || xdim1 != dims_calc_dt_kernel_h[1][0] || xdim2 != dims_calc_dt_kernel_h[2][0] || xdim3 != dims_calc_dt_kernel_h[3][0] || xdim4 != dims_calc_dt_kernel_h[4][0] || xdim5 != dims_calc_dt_kernel_h[5][0] || xdim6 != dims_calc_dt_kernel_h[6][0] || xdim7 != dims_calc_dt_kernel_h[7][0] || xdim8 != dims_calc_dt_kernel_h[8][0] || xdim9 != dims_calc_dt_kernel_h[9][0] || xdim10 != dims_calc_dt_kernel_h[10][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_calc_dt_kernel), dims_calc_dt_kernel_h, sizeof(dims_calc_dt_kernel)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_calc_dt_kernel, grid, tblock, 0, 0,
