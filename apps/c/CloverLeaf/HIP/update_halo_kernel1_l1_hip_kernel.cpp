...
//
__constant__ int dims_update_halo_kernel1_l1 [8][1];
static int dims_update_halo_kernel1_l1_h [8][1] = {{0}};

//user function
__device__

inline void update_halo_kernel1_l1_gpu(ACC<double> &density0,
  ACC<double> &density1,
  ACC<double> &energy0,
  ACC<double> &energy1,
  ACC<double> &pressure,
...
int size1 ){
  ...
  if (size0==-1) dims_update_halo_kernel1_l1[0][0]=0;


  int idx_y = hipBlockDim_y * hipBlockIdx_y + hipThreadIdx_y;
  int idx_x = hipBlockDim_x * hipBlockIdx_x + hipThreadIdx_x;

  arg0 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_l1[0][0];
  arg1 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_l1[1][0];
  arg2 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_l1[2][0];
  arg3 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_l1[3][0];
  arg4 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_l1[4][0];
  arg5 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_l1[5][0];
  arg6 += idx_x * 1*1 + idx_y * 1*1 * dims_update_halo_kernel1_l1[6][0];

  if (idx_x < size0 && idx_y < size1) {
    ACC<double> argp0(dims_update_halo_kernel1_l1[0][0], arg0);
    ACC<double> argp1(dims_update_halo_kernel1_l1[1][0], arg1);
    ACC<double> argp2(dims_update_halo_kernel1_l1[2][0], arg2);
    ACC<double> argp3(dims_update_halo_kernel1_l1[3][0], arg3);
    ACC<double> argp4(dims_update_halo_kernel1_l1[4][0], arg4);
    ACC<double> argp5(dims_update_halo_kernel1_l1[5][0], arg5);
    ACC<double> argp6(dims_update_halo_kernel1_l1[6][0], arg6);
    update_halo_kernel1_l1_gpu(
...
void ops_par_loop_update_halo_kernel1_l1_execute(ops_kernel_descriptor *desc) {
  ...
  if (block->instance->OPS_diags > 1) {
    ops_timing_realloc(block->instance,14,"update_halo_kernel1_l1");
  ...
  if (xdim0 != dims_update_halo_kernel1_l1_h[0][0] || xdim1 != dims_update_halo_kernel1_l1_h[1][0] || xdim2 != dims_update_halo_kernel1_l1_h[2][0] || xdim3 != dims_update_halo_kernel1_l1_h[3][0] || xdim4 != dims_update_halo_kernel1_l1_h[4][0] || xdim5 != dims_update_halo_kernel1_l1_h[5][0] || xdim6 != dims_update_halo_kernel1_l1_h[6][0]) {
    dims_update_halo_kernel1_l1_h[0][0] = xdim0;
    dims_update_halo_kernel1_l1_h[1][0] = xdim1;
    dims_update_halo_kernel1_l1_h[2][0] = xdim2;
    dims_update_halo_kernel1_l1_h[3][0] = xdim3;
    dims_update_halo_kernel1_l1_h[4][0] = xdim4;
    dims_update_halo_kernel1_l1_h[5][0] = xdim5;
    dims_update_halo_kernel1_l1_h[6][0] = xdim6;
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_update_halo_kernel1_l1), dims_update_halo_kernel1_l1_h, sizeof(dims_update_halo_kernel1_l1)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_update_halo_kernel1_l1, grid, tblock, 0, 0,
