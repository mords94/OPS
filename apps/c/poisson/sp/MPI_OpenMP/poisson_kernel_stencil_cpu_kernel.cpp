...
void ops_par_loop_poisson_kernel_stencil_execute(ops_kernel_descriptor *desc) {
  ...
  #ifdef OPS_DEBUG
  ops_register_args(block->instance, args, "poisson_kernel_stencil");
  #endif
  ...
  int xdim2_poisson_kernel_stencil = args[2].dat->size[0];
  ...
  float * __restrict__ f_p = (float *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  float * __restrict__ u2_p = (float *)(args[2].data + base2);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      const ACC<float> u(xdim0_poisson_kernel_stencil, u_p + n_x*1 + n_y * xdim0_poisson_kernel_stencil*1);
      const ACC<float> f(xdim1_poisson_kernel_stencil, f_p + n_x*1 + n_y * xdim1_poisson_kernel_stencil*1);
      ACC<float> u2(xdim2_poisson_kernel_stencil, u2_p + n_x*1 + n_y * xdim2_poisson_kernel_stencil*1);
