...
void poisson_kernel_populate_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    ...
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_float ptr4 = {  p_a4 + n_x*1*1 + n_y*xdim4_poisson_kernel_populate*1*1, xdim4_poisson_kernel_populate};
      ptr_float ptr5 = {  p_a5 + n_x*1*1 + n_y*xdim5_poisson_kernel_populate*1*1, xdim5_poisson_kernel_populate};
