...
void ops_par_loop_poisson_kernel_error_execute(ops_kernel_descriptor *desc) {
  ...
  for (int d=0; d<arg2.dim; d++) ((float *)arg2.data)[d+b*arg2.dim] = ZERO_float;
  reduct_bytes += ROUND_UP(maxblocks*arg2.dim*sizeof(float));
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_poisson_kernel_error,grid ,tblock ,nshared ,0 , (float *)p_a[0], (float *)p_a[1],
