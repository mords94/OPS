...
void poisson_kernel_initialguess_gpu(ACC<float> &u) {
  u(0,0) = 0.0;
}
...
int size1 ){
  ...
  if (size0==-1) dims_poisson_kernel_initialguess[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<float> argp0(dims_poisson_kernel_initialguess[0][0], arg0);
...
void ops_par_loop_poisson_kernel_initialguess_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_poisson_kernel_initialguess_h[0][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_poisson_kernel_initialguess), dims_poisson_kernel_initialguess_h, sizeof(dims_poisson_kernel_initialguess)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_poisson_kernel_initialguess,grid ,tblock ,0 ,0 , (float *)p_a[0],x_size, y_size);
