...
void poisson_kernel_update_gpu(const ACC<float> &u2,
  ACC<float> &u) {
  u(0,0) = u2(0,0);
}
...
int size1 ){
  ...
  if (size0==-1) dims_poisson_kernel_update[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    const ACC<float> argp0(dims_poisson_kernel_update[0][0], arg0);
    ACC<float> argp1(dims_poisson_kernel_update[1][0], arg1);
...
void ops_par_loop_poisson_kernel_update_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim0 != dims_poisson_kernel_update_h[0][0] || xdim1 != dims_poisson_kernel_update_h[1][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_poisson_kernel_update), dims_poisson_kernel_update_h, sizeof(dims_poisson_kernel_update)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_poisson_kernel_update,grid ,tblock ,0 ,0 , (float *)p_a[0], (float *)p_a[1],x_size, y_size);
