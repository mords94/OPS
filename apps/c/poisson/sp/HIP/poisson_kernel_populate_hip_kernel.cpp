...
int size1 ){
  ...
  if (size0==-1) dims_poisson_kernel_populate[0][0]=0;
  ...
  if (idx_x < size0 && idx_y < size1) {
    ACC<float> argp3(dims_poisson_kernel_populate[3][0], arg3);
    ACC<float> argp4(dims_poisson_kernel_populate[4][0], arg4);
    ACC<float> argp5(dims_poisson_kernel_populate[5][0], arg5);
...
void ops_par_loop_poisson_kernel_populate_execute(ops_kernel_descriptor *desc) {
  ...
  if (xdim3 != dims_poisson_kernel_populate_h[3][0] || xdim4 != dims_poisson_kernel_populate_h[4][0] || xdim5 != dims_poisson_kernel_populate_h[5][0]) {
    ...
    hipSafeCall(block->instance->ostream(), hipMemcpyToSymbol(HIP_SYMBOL(dims_poisson_kernel_populate), dims_poisson_kernel_populate_h, sizeof(dims_poisson_kernel_populate)));
  }
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_poisson_kernel_populate,grid ,tblock ,0 ,0 , *(int *)arg0.data, *(int *)arg1.data,
         arg_idx[0], arg_idx[1], (float *)p_a[3],
         (float *)p_a[4], (float *)p_a[5],x_size, y_size);
...
void ops_par_loop_poisson_kernel_populate(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2, ops_arg arg3, ops_arg arg4, ops_arg arg5) {
  ...
  desc->args[0] = arg0;
  char *tmp = (char*)malloc(arg0.dim*sizeof(int));
  memcpy(tmp, arg0.data,arg0.dim*sizeof(int));
  desc->args[0].data = tmp;
  desc->args[1] = arg1;
  tmp = (char*)malloc(arg1.dim*sizeof(int));
