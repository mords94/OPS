...
void poisson_kernel_populate_c_wrapper(
  ...
  for ( int n_y=0; n_y<y_size; n_y++ ){
    for ( int n_x=0; n_x<x_size; n_x++ ){
      ...
      ptr_float u = { u_p + n_x*1 + n_y * xdim3_poisson_kernel_populate*1, xdim3_poisson_kernel_populate};
      ptr_float f = { f_p + n_x*1 + n_y * xdim4_poisson_kernel_populate*1, xdim4_poisson_kernel_populate};
      ptr_float ref = { ref_p + n_x*1 + n_y * xdim5_poisson_kernel_populate*1, xdim5_poisson_kernel_populate};
