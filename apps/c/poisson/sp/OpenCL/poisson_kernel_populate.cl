...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ptr_float ptr3 = { &arg3[base3 + idx_x * 1*1 + idx_y * 1*1 * xdim3_poisson_kernel_populate], xdim3_poisson_kernel_populate};
    ptr_float ptr4 = { &arg4[base4 + idx_x * 1*1 + idx_y * 1*1 * xdim4_poisson_kernel_populate], xdim4_poisson_kernel_populate};
    ptr_float ptr5 = { &arg5[base5 + idx_x * 1*1 + idx_y * 1*1 * xdim5_poisson_kernel_populate], xdim5_poisson_kernel_populate};
