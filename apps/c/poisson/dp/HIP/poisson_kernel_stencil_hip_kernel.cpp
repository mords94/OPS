...
int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ACC<double> argp1(dims_poisson_kernel_stencil[1][0], arg1);
    ACC<double> argp2(dims_poisson_kernel_stencil[2][0], arg2);
...
void ops_par_loop_poisson_kernel_stencil_execute(ops_kernel_descriptor *desc) {
  ...
  if (x_size > 0 && y_size > 0)
    hipLaunchKernelGGL(ops_poisson_kernel_stencil,grid ,tblock ,0 ,0 , (double *)p_a[0], (double *)p_a[1],
