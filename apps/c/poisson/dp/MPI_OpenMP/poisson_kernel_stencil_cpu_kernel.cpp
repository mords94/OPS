...
void ops_par_loop_poisson_kernel_stencil_execute(ops_kernel_descriptor *desc) {
  ...
  double * __restrict__ f_p = (double *)(args[1].data + base1);

  int base2 = args[2].dat->base_offset;
  double * __restrict__ u2_p = (double *)(args[2].data + base2);
  ...
  for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
    ...
    for ( int n_x=start[0]; n_x<end[0]; n_x++ ){
      ...
      const ACC<double> f(xdim1_poisson_kernel_stencil, f_p + n_x*1 + n_y * xdim1_poisson_kernel_stencil*1);
      ACC<double> u2(xdim2_poisson_kernel_stencil, u2_p + n_x*1 + n_y * xdim2_poisson_kernel_stencil*1);
