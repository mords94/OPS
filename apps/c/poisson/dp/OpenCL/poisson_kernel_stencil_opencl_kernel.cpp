...
//
    ...
    void buildOpenCLKernels_poisson_kernel_stencil(OPS_instance *instance, int xdim0, int xdim1, int xdim2) {
...
void ops_par_loop_poisson_kernel_stencil(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1, ops_arg arg2) {
  ...
  buildOpenCLKernels_poisson_kernel_stencil(block->instance,
  xdim0,xdim1,xdim2);
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 3, sizeof(cl_double), (void*) &dx ));
    clSafeCall( clSetKernelArg(block->instance->opencl_instance->OPS_opencl_core.kernel[3], 4, sizeof(cl_double), (void*) &dy ));
