...
void poisson_kernel_stencil(const ptr_double u,
  const ptr_double f,
  ptr_double u2, const double dx, const double dy)
{
...
const int size1 ){
  ...
  if (idx_x < size0 && idx_y < size1) {
    ...
    const ptr_double ptr1 = { &arg1[base1 + idx_x * 1*1 + idx_y * 1*1 * xdim1_poisson_kernel_stencil], xdim1_poisson_kernel_stencil};
    ptr_double ptr2 = { &arg2[base2 + idx_x * 1*1 + idx_y * 1*1 * xdim2_poisson_kernel_stencil], xdim2_poisson_kernel_stencil};
